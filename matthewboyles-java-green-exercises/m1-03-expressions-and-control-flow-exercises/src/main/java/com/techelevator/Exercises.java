...
public class Exercises {
	...
	public boolean parrotTrouble(boolean talking, int hour) {
		return talking == true && (hour > 20 || hour < 7) ? true : false;
	}
	...
	public boolean posNeg(int a, int b, boolean negative) {
		return  a < 0 && b < 0 && negative || a < 0 ^ b < 0 && !negative? true : false;
	}
	...
	public boolean icyHot(int temp1, int temp2) {
		return   temp1 < 0 && temp2 > 100 || temp1 > 0 && temp2 < 0 ? true :false;
	}
	...
	/*
	 ...
	 max1020(11, 9) → 11
	 */
	public int max1020(int a, int b) {// 11  21    .>11
		//return  a >= 10 && a <= 20 && b >= 10 && b <= 20 ? a > b ? a : b > a ? b : 0 : 0;
		if (b > a) {
			int temp = a;
			a = b;
			b = temp;
	...
	public boolean inOrderEqual(int a, int b, int c, boolean equalOk) {
		return !equalOk && a < b && b < c ? true : equalOk && a <= b && b <= c ? true : false;
	}
