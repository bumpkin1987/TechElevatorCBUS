...
public class Exercises {
	...
	public String extraEnd(String str) {
		String partString = str.substring(str.length() - 2);
		return  partString + partString + partString;
	}
	...
	public String stringBits(String str) {
		//create a string and add chars to that string
		//loop and modulus check but odds bc of indexing ------ practice testing more often
		String myStr = "";
	...
	/*
	 ...
	 last2("axxxaaxx") → 2
	 */
	public int last2(String str) {// first assign the value of str.substring(str.length - 2) to a var
